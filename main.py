...
if __name__ == '__main__':
    ...
    model.fit()    # Trains the model by running the fit() method. This will perform the full training loop,
    # including iterating through batches, computing loss, updating parameters, evaluating metrics,
    # saving checkpoints, etc. The details of the training loop are handled in the fit() method.
